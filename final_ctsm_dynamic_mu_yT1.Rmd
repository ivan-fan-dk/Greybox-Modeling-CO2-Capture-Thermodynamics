...
load_data <- function(arg){
  ...
  csv <- read_csv(csv_name, show_col_types = FALSE)
...
gg <- ggplot(df, aes(x = time)) +
  ...
  # geom_point(aes(y = (q_circ*T0 + q_des*T_des)/(q_circ + q_des), color = "(q_circ*T0 + q_des*T_des)/(q_circ + q_des)"), size = 0.2) +
